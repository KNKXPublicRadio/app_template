...
```
* * * * * ubuntu bash /home/ubuntu/apps/test/repository/cron.sh fab $DEPLOYMENT_TARGET cron_jobs.test
```
...
|--------|------|-----|-----|
|test|tweet|`location`||
|test|facebook|`location`||
|test|email|`location`||
|test|new-comment||
|test|open-share-discuss||
|test|close-share-discuss||
|test|summary-copied||
|test|featured-tweet-action|`action`|
|test|featured-facebook-action|`action`|
